...
class PreprocessTest(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.repo_name = "github-actions-test-organisation/github-interaction-test"
        self.repo_folder = "xml"

    def test_preprocess_with_github(self):
        asyncio.run(self.preprocessor.preprocess(process_id=self.process_id,
    ...
    def test_preprocess_abbrev_true(self):
        asyncio.run(self.preprocessor.preprocess_xml_file_list(self.xml_files, self.in_path, self.out_path, abbrev=True))
