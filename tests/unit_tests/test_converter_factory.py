...
class TestConverterFactory:
    ...
    def test_init_default_parser(self):
        ...
        with patch("flow_preprocessing.preprocessing_logic.converter_factory.XmlParser"):
    ...
    def test_create_zip_converter_local(self, mock_parser_class, mock_converter_class):
    ...
    @patch("flow_preprocessing.preprocessing_logic.converter_factory.XmlConverter")
    @patch("flow_preprocessing.preprocessing_logic.converter_factory.XmlParser")
    def test_create_zip_converter_url_http(self, mock_parser_class, mock_converter_class):
    ...
    @patch("flow_preprocessing.preprocessing_logic.converter_factory.XmlConverter")
    @patch("flow_preprocessing.preprocessing_logic.converter_factory.XmlParser")
    def test_create_zip_converter_url_https(self, mock_parser_class, mock_converter_class):
    ...
    @patch("flow_preprocessing.preprocessing_logic.converter_factory.XmlConverter")
    @patch("flow_preprocessing.preprocessing_logic.converter_factory.XmlParser")
    def test_create_zip_converter_with_dataset(self, mock_parser_class, mock_converter_class):
    ...
    @patch("flow_preprocessing.preprocessing_logic.converter_factory.XmlConverter")
    @patch("flow_preprocessing.preprocessing_logic.converter_factory.XmlParser")
    def test_create_zip_converter_parse_xml_false(self, mock_parser_class, mock_converter_class):
        """Test that parse_xml parameter is correctly passed."""
        factory = ConverterFactory()

        _ = factory.create_zip_converter(zip_path="/path/to/data.zip", parse_xml=False)
    ...
    @patch("flow_preprocessing.preprocessing_logic.converter_factory.XmlConverter")
    @patch("flow_preprocessing.preprocessing_logic.converter_factory.XmlParser")
    def test_create_huggingface_converter_from_repo(self, mock_parser_class, mock_converter_class):
    ...
    @patch("flow_preprocessing.preprocessing_logic.converter_factory.XmlConverter")
    @patch("flow_preprocessing.preprocessing_logic.converter_factory.XmlParser")
    def test_create_huggingface_converter_with_dataset(self, mock_parser_class, mock_converter_class):
        """Test creation of converter with existing dataset."""
        factory = ConverterFactory()
        mock_dataset = Mock()

        _ = factory.create_huggingface_converter(
            repo_id="organization/dataset", token="hf_xxx", parse_xml=True, dataset=mock_dataset
        )
    ...
    @patch("flow_preprocessing.preprocessing_logic.converter_factory.XmlConverter")
    @patch("flow_preprocessing.preprocessing_logic.converter_factory.XmlParser")
    def test_create_huggingface_converter_no_token(self, mock_parser_class, mock_converter_class):
    ...
    @patch("flow_preprocessing.preprocessing_logic.converter_factory.XmlConverter")
    @patch("flow_preprocessing.preprocessing_logic.converter_factory.XmlParser")
    def test_create_huggingface_converter_parse_xml_false(self, mock_parser_class, mock_converter_class):
        """Test that parse_xml parameter is correctly passed."""
        factory = ConverterFactory()

        _ = factory.create_huggingface_converter(
            repo_id="organization/dataset", token="hf_xxx", parse_xml=False
        )
    ...
    @patch("flow_preprocessing.preprocessing_logic.converter_factory.XmlConverter")
    @patch("flow_preprocessing.preprocessing_logic.converter_factory.XmlParser")
    def test_create_dataset_converter(self, mock_parser_class, mock_converter_class):
        """Test private method _create_dataset_converter."""
        factory = ConverterFactory()
        mock_dataset = Mock()

        _ = factory._create_dataset_converter(
            dataset=mock_dataset, parse_xml=True, source_path="/original/path"
        )
    ...
    @patch("flow_preprocessing.preprocessing_logic.converter_factory.XmlConverter")
    @patch("flow_preprocessing.preprocessing_logic.converter_factory.XmlParser")
    def test_multiple_converters_from_same_factory(self, mock_parser_class, mock_converter_class):
    ...
    @patch("flow_preprocessing.preprocessing_logic.converter_factory.XmlConverter")
    @patch("flow_preprocessing.preprocessing_logic.converter_factory.XmlParser")
    def test_factory_uses_same_parser(self, mock_parser_class, mock_converter_class):
...
class TestConverterFactoryEdgeCases:
    ...
    @patch("flow_preprocessing.preprocessing_logic.converter_factory.XmlConverter")
    @patch("flow_preprocessing.preprocessing_logic.converter_factory.XmlParser")
    def test_empty_zip_path(self, mock_parser_class, mock_converter_class):
        """Test handling of empty zip path."""
        factory = ConverterFactory()

        # Empty path should still work (validation is not factory's responsibility)
        _ = factory.create_zip_converter(zip_path="", parse_xml=True)
    ...
    @patch("flow_preprocessing.preprocessing_logic.converter_factory.XmlConverter")
    @patch("flow_preprocessing.preprocessing_logic.converter_factory.XmlParser")
    def test_special_characters_in_path(self, mock_parser_class, mock_converter_class):
        """Test handling of special characters in paths."""
        factory = ConverterFactory()

        special_path = "/path/with spaces/and-dashes/file (1).zip"
        _ = factory.create_zip_converter(zip_path=special_path, parse_xml=True)
    ...
    @patch("flow_preprocessing.preprocessing_logic.converter_factory.XmlConverter")
    @patch("flow_preprocessing.preprocessing_logic.converter_factory.XmlParser")
    def test_url_with_query_parameters(self, mock_parser_class, mock_converter_class):
        """Test handling of URL with query parameters."""
        factory = ConverterFactory()

        url = "https://example.com/data.zip?token=abc&version=1"
        _ = factory.create_zip_converter(zip_path=url, parse_xml=True)
